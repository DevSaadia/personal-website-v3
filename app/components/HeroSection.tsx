...
const HeroSection = () => {
    return (
        <section
            ...
            items-center 
            '>
            <div className='flex flex-col-reverse  md:flex-row items-center justify-center md:justify-between gap-8 md:gap-4 lg:gap-10 xl:gap-16  m-8 md:m-8 2xl:m-56 w-full '>
                <div id='hero-content' className='md:flex-1 md:w-11/12 w-full'>
                    ...
                    <p className={`w-full xl:w-2/3 2xl:w-5/6 ${averageSans.className} text-xl lg:text-2xl mb-6 `}>Driven by creativity, innovation and a desire to foster community among the minority groups in the tech industry.</p>
