        ...
        <section
            ...
            <div className='flex flex-col-reverse  md:flex-row items-center justify-center md:justify-between gap-8 md:gap-4 lg:gap-10 xl:gap-16  m-8 md:m-24 2xl:m-56 w-full '>
                <div id='hero-content' className='md:flex-1 md:w-11/12 w-full'>
                    ...
                    <h1
                        className={`mb-7 md:pt-2 text-6xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold whitespace-nowrap text-transparent w-full bg-clip-text   bg-gradient-to-r from-[#e54971] to-[#e2a812] ${spaceMono.className} `}>&gt;
                        <TypeAnimation
                            className='ml-6 '
                ...
                <div id='hero-image' className='md:flex-1 flex justify-center md:justify-end '>
                    <div className=' relative w-[400px] h-[400px] md:w-[300px] md:h-[300px] lg:w-[400px] lg:h-[400px] xl:w-[500px] xl:h-[500px] '>
                        <Image
