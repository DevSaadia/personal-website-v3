        ...
        <section
            ...
            <div className='flex flex-col-reverse  md:flex-row items-center justify-center md:justify-between gap-8  md:gap-24 lg:gap-96 p-8 md:p-40 w-full'>
                <div id='hero-content' className='md:flex-1 '>
                    ...
                    <p className={`w-full md:w-96 ${averageSans.className} text-xl  mb-6`}>Driven by creativity, innovation and a desire to foster community among the minority groups in the tech industry.</p>
