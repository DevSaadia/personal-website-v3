  ...
  return (
    ...
    '>
      <div className='flex  gap-8 p-8 md:p-40 flex-col'>
        <h1
          className={`mb-7 text-5xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-transparent md:w-1/4 w-1/2 bg-clip-text  bg-gradient-to-r from-[#ffffff] to-[#e2a812] ${spaceMono.className}`}>&gt;
          about
        </h1>
