  ...
  return (
    <section
      ...
      <div className='flex gap-8 flex-col w-full m-8 md:m-24 2xl:m-56 '>
        <h1
          className={`mb-7 text-5xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-[#e54971] to-[#e2a812] ${spaceMono.className}`}>&gt; projects </h1>
